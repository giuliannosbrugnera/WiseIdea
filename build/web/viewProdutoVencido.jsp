Início<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <title>Wise Idea | Produto vencido</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li id="section2"><a href="index.html#sec2">Produtos</a></li>
                        <li id="section3"><a href="index.html#sec3">Vender produtos</a></li>
                        <li id="section4"><a href="index.html#sec4">Clientes</a></li>
            ...
            <div class="row row-offcanvas row-offcanvas-right">
                <div class="col-xs-12 col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Produto vencido</li>
                    </ol>
                    ...
                    <div class="jumbotron" id="main">
                        <h1 style="color: red;">O produto está vencido!</h1>
                        <h3>Escolha outro produto para vender.</h3>
                    </div>
                ...
                <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                    <div class="list-group">
                        ...
                        <a href="index#sec2" id="buscarprodutos" class="list-group-item">
                            <span class="glyphicon glyphicon-search"></span> Pesquisar produtos
                        </a>
                        <a href="index#sec3" id="venderprodutos" class="list-group-item">
                            <span class="glyphicon glyphicon-usd"></span> Vender produtos</a>
                        <a href="index#sec4" id="buscarclientes" class="list-group-item">
