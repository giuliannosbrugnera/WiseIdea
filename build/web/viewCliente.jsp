...
<html>
    <head>
        ...
        <title>Wise Idea | Clientes</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="index.html#sec4">Clientes</a></li>
        ...
        <div class="container">
            <div class="row row-offcanvas row-offcanvas-right">
                <div class="col-xs-12 col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index.html">Início</a></li>
                        <li><a href="index.html#sec4">Pesquisar clientes</a></li>
                        <li class="active">Resultado clientes</li>
                    </ol>
                    ...
                    <div id="menu" class="panel panel-default" style="margin-bottom: 70px;">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTable" id="table_clientes">
                                    <thead>
                                        <tr>
                                            <th>CPF ou CNPJ</th>
                    ...
                    <!-- Modal configuração limite de dias -->
                ...
                <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                    <div class="list-group">
                        ...
                        <a href="index.html#sec4" id="buscarclientes" class="list-group-item active">
