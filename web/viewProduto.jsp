...
<html>
    <head>
        ...
        <title>Wise Idea | Produtos</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="index.html#sec2">Produtos</a></li>
        ...
        <div class="container">
            <div class="row row-offcanvas row-offcanvas-right">
                <div class="col-xs-12 col-sm-9">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="index.html">Início</a></li>
                        <li><a href="index.html#sec2">Pesquisar produtos</a></li>
                        <li class="active">Resultado produtos</li>
                    </ol>
                    ...
                    <div id="menu" class="panel panel-default" style="margin-bottom: 70px;">
                        ...
                        <div class="panel-body">
                            <%
                                ...
                                if ( produtos.isEmpty() ) {
                            %>
                            <h4> Resultados não encontrados. <a href="index.html#sec2" id="buscarprodutos">Tente novamente</a></h4>
                            <% }
                            else { %> 
                                ...
                                <table class="table table-striped table-bordered table-hover dataTable" id="table_produtos">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <td><%=produto.getLimiteValidade().toString()%></td>
                                        </tr>
                                        <%} %>
                                    </tbody>
                                </table>
                    ...
                    <div class="modal fade" id="modalsucesso" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" id="closeicon"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
                    <div class="list-group">
                        ...
                        <a href="index.html#sec2" id="buscarprodutos" class="list-group-item active">
